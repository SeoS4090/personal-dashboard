...
| `.toggle-switch`, `.toggle-slider` | ON/OFF 토글 스위치 (캘린더 활성화 등) |
| `.readme-tab-bar`, `.readme-tab`, `.readme-tab-content` | ReadMe 패널 탭 UI |
| `.code-inline` | ReadMe 내 인라인 코드 강조 |
| `.readme-steps` | ReadMe 단계별 목록 (ol/ul 공용) |
